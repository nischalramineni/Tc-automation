...
WebDriver driver;
	...
	private By NewModule		= By.xpath("//button[contains(@class,'btn js-toggle-show js-toggle-hide-on-show')]");
	private By ModTitle			= By.id("course_module_title");
	private By CreateModule     = By.xpath("//input[contains(@class,'btn primary a-create-course-module')]");
	
	//private By ModDesc			= By.xpath("//div[contains(@class,'tinymce-input--toolbar')]");
	...
	//Attach Resources
		...
		private By CreateLesson		= By.xpath("//input[contains(@class,'btn primary a-create-course-lesson')]");
	...
	public void clickNewModule(){
		...
		WebElement element = wait.until(ExpectedConditions.elementToBeClickable(NewModule));
		element.click();		
	}
	
	public void setModuleTitle(String ModName){
		WebDriverWait wait = new WebDriverWait(driver,10);
		WebElement element = wait.until(ExpectedConditions.elementToBeClickable(ModTitle));
		element.click();
		element.sendKeys(ModName);
	}
	
	public void clickCreateModule(){
		
		WebDriverWait wait = new WebDriverWait(driver,10);
		WebElement element = wait.until(ExpectedConditions.elementToBeClickable(CreateModule));
		element.click();		
	}
	
	public void setModuleDesc(String ModDescr){
		driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
		driver.switchTo().defaultContent();	
		
		WebElement frame = driver.findElement(By.xpath("//*[contains(@id, 'course_lesson_body_ifr')]"));
		driver.switchTo().frame(frame); 	
	
		driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
		WebElement body = driver.findElement(By.cssSelector("body"));
		body.click();
		body.sendKeys(ModDescr);
		driver.switchTo().defaultContent();
	...
	*/
	...
	public void clickCreateLesson() throws InterruptedException{
	//	List <WebElement> allChildobjs = driver.findElements(By.xpath("//li[contains(@class,'js-resource spaced-list--item')]"));
		WebDriverWait wait = new WebDriverWait(driver,10);
		driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
		wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.xpath("//li[contains(@class,'js-resource spaced-list--item')]")));
		wait.until(ExpectedConditions.elementToBeClickable(AttachResources));
		driver.findElement(AttachResources).isEnabled();
		WebElement element = wait.until(ExpectedConditions.elementToBeClickable(CreateLesson));
		try {
